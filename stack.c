// Making a stack- a linked list with two operations, push and pop.
// Push appends to the begin of the list.
// Pop will return the value of the first item and delete it from the list.
#include <stdio.h>
#include <stdlib.h>
...
void push(struct linked_list* list, int appendee) {
...
int pop(struct linked_list* list) {
